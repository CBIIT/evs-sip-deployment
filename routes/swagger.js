  ...
  return {
    ...
    'tags': [
      /*
      {
        ...
        'description': 'RESTful APIs provide flexibilities for searching data using hierarchical patterns from Data Models.'
      },
      {
        'name': 'DataModel Data',
        'description': 'RESTful APIs are used to retrieve data per dataset source from DataModels.'
      },
      */
      {
        'name': 'ES Search',
